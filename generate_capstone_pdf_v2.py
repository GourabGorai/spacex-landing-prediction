...
# Custom Palette & Styles (ASCII-Only Text Layer)
...
github_url = "GitHub URL: https://github.com/GourabGorai/spacex-landing-prediction"
...
cover_info = [
    [Paragraph("<b>Course:</b> IBM Applied Data Science Capstone Project", body_style)],
    ...
    [Paragraph("<b>Status:</b> Complete - All 15 Evaluation Rubric Criteria Fulfilled", body_style)]
]
t_cover = Table(cover_info, colWidths=[540], hAlign='CENTER')
...
# ----------------------------------------------------
# Slide 2: Executive Summary (Question 1.3)
# ----------------------------------------------------
story.extend(make_header("Executive Summary", "Project Scope, Core Methodology & Key Analytical Findings"))
exec_summary_text = [
    [
...
# ----------------------------------------------------
# Slide 3: Introduction (Question 1.4)
# ----------------------------------------------------
story.extend(make_header("Introduction", "Commercial Aerospace Industry & Problem Statement"))
intro_content = [
    [
        Paragraph("<b>Commercial Space Industry Context</b><br/>The space launch market has historically been dominated by government defense primes charging upwards of $60 Million to $165 Million per orbital launch.<br/><br/>SpaceX disrupted the industry by developing reusable Falcon 9 boosters. By landing the first stage back on ground pads or Autonomous Spaceport Drone Ships (ASDS), SpaceX re-flies core boosters multiple times, reducing costs to ~$20 Million.", body_style),
        Paragraph("<b>Project Objectives & Goal</b><br/>- <b>Data Mining:</b> Ingest launch data from SpaceX REST API and web scrape historical Wikipedia launch records.<br/>- <b>Exploratory Analysis:</b> Analyze trends in launch sites, payload mass, orbit types, and yearly success rates.<br/>- <b>Interactive Analytics:</b> Construct web dashboards (Plotly Dash) and geospatial maps (Folium).<br/>- <b>Predictive Model:</b> Train classification ML models to predict Falcon 9 first stage landing success (Class = 1 vs Class = 0).", body_style)
    ]
]
...
# ----------------------------------------------------
# Slide 4: Data Collection - SpaceX API (Question 1.5)
# ----------------------------------------------------
story.extend(make_header("Data Collection - SpaceX API", "API Pipeline Workflow & Data Ingestion Methodology"))
story.append(Paragraph("<b>SpaceX API Integration Workflow:</b> API endpoint <code>https://api.spacexdata.com/v4/launches/past</code> was requested using <code>requests.get()</code>, normalized via <code>json_normalize()</code>, and enriched with core, payload, and launchpad metadata.", body_style))
...
# ----------------------------------------------------
# Slide 5: Data Collection - Web Scraping (Question 1.6)
# ----------------------------------------------------
story.extend(make_header("Data Collection - Web Scraping", "HTML Parsing with BeautifulSoup & Data Extraction Pipeline"))
...
# ----------------------------------------------------
# Slide 6: Data Wrangling Methodology (Question 1.7)
# ----------------------------------------------------
story.extend(make_header("Data Wrangling Methodology", "Data Cleaning, Imputation, Target Encoding & One-Hot Encoding"))
wrangling_table = [
    [
        Paragraph("<b>1. Handling Missing Data</b><br/>- <code>PayloadMass</code> column contained missing values for early launches.<br/>- Calculated mean payload mass (<b>6,104.96 kg</b>) and imputed missing entries to preserve sample size (N=90).", body_style),
        Paragraph("<b>2. Target Class Creation</b><br/>- Analyzed 8 distinct categorical landing outcome strings.<br/>- Encoded successful landings (Ground Pad, ASDS Drone Ship) as <b>Class = 1</b>.<br/>- Encoded failures and unattempted landings as <b>Class = 0</b>.", body_style)
    ],
    [
...
# ----------------------------------------------------
# Slide 7: EDA with Data Visualization (Question 1.8)
# ----------------------------------------------------
story.extend(make_header("EDA with Data Visualization", "Chart Types, Analytical Purpose & Business Objectives"))
eda_overview_data = [
...
# ----------------------------------------------------
# Slide 8: EDA Visualization Results (Question 1.11)
# ----------------------------------------------------
story.extend(make_header("EDA Visualization Results", "Scatter Plots & Launch Site Distribution Patterns"))
...
# ----------------------------------------------------
# Slide 9: EDA Visualization Results - Orbit and Yearly Trends (Question 1.11)
# ----------------------------------------------------
story.extend(make_header("EDA Visualization Results - Orbit and Yearly Trends", "Orbit Type Success Ratios & Technological Learning Curve"))
...
# ----------------------------------------------------
# Slide 10: EDA with SQL Results (Question 1.9 & 1.12)
# ----------------------------------------------------
story.extend(make_header("EDA with SQL Results", "Relational Database Analytics on SPACEXTBL (SQLite)"))
...
# ----------------------------------------------------
# Slide 11: Folium Map Results (Question 1.10 & 1.13)
# ----------------------------------------------------
story.extend(make_header("Folium Map Results", "Launch Site Clusters, Landing Markers & Proximity Analysis"))
...
# ----------------------------------------------------
# Slide 12: Plotly Dash Results (Question 1.10 & 1.14)
# ----------------------------------------------------
story.extend(make_header("Plotly Dash Results", "Dynamic Filtering by Launch Site & Payload Mass Range"))
...
# ----------------------------------------------------
# Slide 13: Predictive Analysis (Classification) (Question 1.15)
# ----------------------------------------------------
story.extend(make_header("Predictive Analysis (Classification)", "Standardization, 10-Fold CV & GridSearchCV Hyperparameter Tuning"))
...
# ----------------------------------------------------
# Slide 14: Predictive Analysis Results (Question 1.15)
# ----------------------------------------------------
story.extend(make_header("Predictive Analysis Results", "Test Accuracy Comparison, Confusion Matrices & ROC Curves"))
...
# ----------------------------------------------------
# Slide 15: Conclusion and Innovative Insights (Question 1.15)
# ----------------------------------------------------
story.extend(make_header("Conclusion and Innovative Insights", "Best Algorithm Explanation & Commercial Space Strategy Insights"))
final_table_data = [
...
print(f"Text Layer Audit: {non_ascii_count} non-ASCII characters found.")
if non_ascii_count == 0:
    print("PERFECT! 100% clean ASCII text layer across all 15 slides!")
